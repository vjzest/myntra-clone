const convenienceFee = 99; // Corrected constant name
...
function displayBagSummary() {
    ...
    bagItemObjects.forEach(bagItem => {
        totalMRP += bagItem.original_price;  // Fixed property name
        totalDiscount += bagItem.original_price - bagItem.current_price;
    });
    
    let finalPayment = totalMRP - totalDiscount + convenienceFee; // Used correct constant name
